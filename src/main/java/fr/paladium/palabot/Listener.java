    ...
    public void onEvent(GenericEvent event)
    {
        ...
        else if (event instanceof GuildMessageUpdateEvent)
        {
            ...
            if(!m.getAuthor().isBot()) // ignore bot edits
            {
                ...
                MessageCache.CachedMessage old = vortex.getMessageCache().putMessage(m);
        ...
        else if (event instanceof GuildMessageDeleteEvent)
        {
            ...
            // Log the deletion
            MessageCache.CachedMessage old = vortex.getMessageCache().pullMessage(gevent.getGuild(), gevent.getMessageIdLong());
        ...
        else if (event instanceof GuildUnbanEvent)
        {
            ...
            vortex.getDatabaseMongo().tempbans.clearBan(gue.getGuild(), gue.getUser().getIdLong());
        ...
        else if (event instanceof GuildMemberRoleRemoveEvent)
        {
            ...
            {
                vortex.getDatabaseMongo().tempmutes.removeMute(gmrre.getGuild(), gmrre.getUser().getIdLong());
