...
import fr.paladium.palabot.database.managers.AutomodManager;
import fr.paladium.palabot.database.managers.AutomodManager.AutomodSettings;
import fr.paladium.palabot.automod.URLResolver.*;
import fr.paladium.palabot.utils.FixedCache;
...
public class AutoMod
{
    ...
    public void memberJoin(GuildMemberJoinEvent event)
    {
        ...
        {
            if(vortex.getDatabaseMongo().tempmutes.isMuted(event.getMember()))
            {
                try
                {
                    event.getGuild()
