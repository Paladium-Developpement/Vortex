...
import fr.paladium.palabot.commands.CommandExceptionListener.CommandWarningException;
...
public class CleanCmd extends ModCommand
{
    ...
    protected void execute(CommandEvent event)
    {
        ...
        event.async(() -> {
            ...
            OffsetDateTime earliest = event.getMessage().getTimeCreated().minus(System.currentTimeMillis() - 1209600000L, ChronoUnit.MILLIS);
            while(val>100)
            {
