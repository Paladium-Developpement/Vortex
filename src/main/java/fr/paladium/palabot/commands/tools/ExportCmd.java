 ...
 */
package fr.paladium.palabot.commands.tools;
...
public class ExportCmd extends Command
{
    ...
    protected void execute(CommandEvent event)
    {
        ...
        DatabaseMongo dbm = vortex.getDatabaseMongo();
        JSONObject obj = new JSONObject()
                ...
                .put("tempmutes", dbm.tempmutes.getAllMutesJson(g))
                .put("tempbans", dbm.tempbans.getAllBansJson(g))
