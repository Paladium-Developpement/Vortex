...
import fr.paladium.palabot.database.managers.GuildSettingsDataManager.GuildSettings;
...
import fr.paladium.palabot.utils.LogUtil.ParsedAuditReason;
            ...
            for(AuditLogEntry ale: vortex.getDatabase().auditcache.filterUncheckedEntries(list)) 
            {
                ...
                if(act!=null)
                {
                    ...
                    if(act==Action.UNBAN) // check for softban
                    {
                        ...
                        vortex.getDatabaseMongo().tempbans.clearBan(guild, ale.getTargetIdLong());
                    }
                    if(act==Action.UNMUTE)
                    {
                        vortex.getDatabaseMongo().tempmutes.removeMute(guild, ale.getTargetIdLong());
                    }
