 ...
 */
package fr.paladium.palabot.utils;
...
public class LogUtil
{
    ...
    public static String logCachedMessagesForwards(String title, List<MessageCache.CachedMessage> messages, MultiBotManager botManager)
    {
    ...
    public static String logCachedMessagesForwards(String title, List<MessageCache.CachedMessage> messages, ShardManager shardManager)
    {
    ...
    public static boolean checkProofValidity(String proof)
    {
        Matcher regex = Pattern.compile("https?:\\/\\/(www\\.)?[-a-zA-Z0-9@:%._\\+~#=]{1,256}\\.[a-zA-Z0-9()]{1,6}\\b([-a-zA-Z0-9()@:%_\\+.~#?&//=]*)").matcher(proof);
        while (regex.find()) {
             return true;
        }
        return false;
